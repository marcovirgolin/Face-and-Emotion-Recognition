...
marco_image = face_recognition.load_image_file("images/Marco.jpg")
...
''' Credit to nathancy: https://stackoverflow.com/questions/56580450/webcam-can-not-show-picture-with-opencv-in-python-3-7'''
...
while True:
    try:
        video_stream_widget.show_frame_n_do_stuff()
